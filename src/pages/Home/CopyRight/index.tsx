        ...
        <div className={styles.copyRight}>
            ...
            >
                <div data-tooltip-id="my-tooltip"
                    ...
                    数据说明
                    <Tooltip id="my-tooltip" data-tooltip-offset={0} style={{ backgroundColor: "#ffffff", color: "#000", width: 526, zIndex: 100 }} >
                    </Tooltip>
                </div>
            </div>
