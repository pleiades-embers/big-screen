            ...
            <div
                ...
                <div data-tooltip-id="my-tooltip"
                    data-tooltip-html={`<div>版权归属：
                        ...
                        说明：
                        <br/>
                        “生命安全指数”的数据从WHO，世界银行，联合国等权威国际组织，筛选与人类生命安全相关的基础数据入手，以确保数据的权威性及全面性。同时，该指数密切跟踪社会环境风险及自然环境风险相关的权威数据库，并且从新闻媒体、社交网络等分析与生命安全相关的报道，分析与国别相关的生命安全相关情况，并归一化形成指数模型。 <br/><br/>
                        通过语义分析，聚类分析等模型方法，分成公共卫生、自然风险、社会风险、心理健康等四个维度，同时考虑到不同国家经济、人口等情况，评价不同国家和地区的生命安全状况，形成评价体系。其中语义实体模型NER从传染病新闻中提取时间、地点、传染病等核心信息。根据经济总量、人口等，用k均值聚类分析等算法，对不同国家和地区进行聚类分析，对不同类型的数据做归一化分析，避免长尾效应对归一化分析的影响。<br/> <br/>
                        The "Life Safety Index" selects basic data related to human life safety from authoritative international organizations such as WHO, World Bank, and the United Nations to ensure the authority and comprehensiveness of the data. At the same time, the index closely tracks authoritative databases related to social and natural environment risks, and analyzes life safety-related reports from news media, social networks, etc., to analyze life safety-related situations related to different countries and normalize them to form an index model. <br/><br/>
